...
def my_func(a):
    ...
    if set(a).difference(latin_char):
        return 'только МАЛЕНЬКИЕ ЛАТИНСКИЕ'
    ...
    return total_str
print(my_func(input('Введите строку из слов разделенных пробелами маленькими латинскими буквами')))
